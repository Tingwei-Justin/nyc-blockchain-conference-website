        ...
        <div className={styles.iconList}>
          {
            strategicImgList.map((item, index) => {
              return (
                <div key={index}>
                  <Image src={item} alt='' className={styles.strategicPartnersIcon}></Image>
                </div>
              )
            })
          }
        ...
        <div className={styles.iconList}>
          {
            submitImgList.map((item, index) => {
              return (
                <div key={index}>
                  <Image src={item} alt='' className={styles.summitPartnersIcon}></Image>
                </div>
              )
            })
          }
            ...
            footerIconTextList.map((item, index) => {
              return (
                <div key={index} className={styles.concatItem}>
                  <Image src={item.icon} alt='' className={styles.concatIcon}></Image>
                  {item.text}
                </div>
              )
            })
