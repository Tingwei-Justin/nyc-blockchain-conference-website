  ...
  return (
    <div className={styles.banner}>
          ...
          bannerStyleList.map((item, index) => {
            return (
              <div className={styles.bannerStyleItem} key={index}>
                <Image className={styles.bannerItemImage} alt='' src={item}></Image>
              </div>
            )
          })
        }
      ...
      <div className={styles.bannerContent}>
        <div>
          <div className={styles.title}>Bit Block Summit <span className={styles.nyc}>NYC</span></div>
        ...
        <div className={styles.meetingInfo}>
          ...
          <div className={styles.meetInfoContent}>
            <div className={styles.infoDate}>Date : <span className={styles.date}>June 02-03</span> • NYC</div>
          </div>
        </div>
      </div>
    </div>
